...
func (strct *VerificationResultValidator) MarshalJSON() ([]byte, error) {
	...
	buf.WriteString("{")
    comma := false
    // Marshal the "attestationSignature" field
    if comma { 
        buf.WriteString(",") 
    }
    buf.WriteString("\"attestationSignature\": ")
	if tmp, err := json.Marshal(strct.AttestationSignature); err != nil {
		return nil, err
 	} else {
 		buf.Write(tmp)
	}
	...
	comma = true
    // Marshal the "identityCertificate" field
    if comma { 
        buf.WriteString(",") 
    }
    buf.WriteString("\"identityCertificate\": ")
	if tmp, err := json.Marshal(strct.IdentityCertificate); err != nil {
		return nil, err
 	} else {
 		buf.Write(tmp)
	}
    ...
    if strct.Organization == nil {
        return nil, errors.New("organization is a required field")
    }
...
func (strct *VerificationResultValidator) UnmarshalJSON(b []byte) error {
    ...
    for k, v := range jsonMap {
        ...
        case "attestationSignature":
            if err := json.Unmarshal([]byte(v), &strct.AttestationSignature); err != nil {
                return err
             }
        case "extension":
        ...
        case "identityCertificate":
            if err := json.Unmarshal([]byte(v), &strct.IdentityCertificate); err != nil {
                return err
             }
        ...
        case "organization":
            ...
            organizationReceived = true
        default:
            return fmt.Errorf("additional property not allowed: \"" + k + "\"")
        }
    }
    // check if organization (a required property) was received
    if !organizationReceived {
        return errors.New("\"organization\" is required but was not present")
    }
    return nil
}
