...
func (strct *RiskEvidenceSynthesis) MarshalJSON() ([]byte, error) {
	...
	comma = true
    // Marshal the "riskEstimate" field
    if comma { 
        buf.WriteString(",") 
    }
    buf.WriteString("\"riskEstimate\": ")
	if tmp, err := json.Marshal(strct.RiskEstimate); err != nil {
		return nil, err
 	} else {
 		buf.Write(tmp)
	}
...
func (strct *RiskEvidenceSynthesis) UnmarshalJSON(b []byte) error {
    ...
    for k, v := range jsonMap {
        ...
        case "riskEstimate":
            if err := json.Unmarshal([]byte(v), &strct.RiskEstimate); err != nil {
                return err
             }
        case "sampleSize":
