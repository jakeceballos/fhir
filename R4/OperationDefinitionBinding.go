...
func (strct *OperationDefinitionBinding) UnmarshalJSON(b []byte) error {
    ...
    for k, v := range jsonMap {
        ...
        case "valueSet":
            ...
            valueSetReceived = true
        default:
            return fmt.Errorf("additional property not allowed: \"" + k + "\"")
        }
    }
    // check if valueSet (a required property) was received
    if !valueSetReceived {
        return errors.New("\"valueSet\" is required but was not present")
    }
    return nil
}
