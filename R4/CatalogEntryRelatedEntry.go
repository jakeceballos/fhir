...
type CatalogEntryRelatedEntry struct {
  ...
  Relationtype interface{} `json:"relationtype,omitempty"`
}
...
func (strct *CatalogEntryRelatedEntry) MarshalJSON() ([]byte, error) {
	...
	comma = true
    // Marshal the "relationtype" field
    if comma { 
        buf.WriteString(",") 
    }
    buf.WriteString("\"relationtype\": ")
	if tmp, err := json.Marshal(strct.Relationtype); err != nil {
		return nil, err
 	} else {
 		buf.Write(tmp)
	}
...
func (strct *CatalogEntryRelatedEntry) UnmarshalJSON(b []byte) error {
    ...
    for k, v := range jsonMap {
        ...
        case "relationtype":
            if err := json.Unmarshal([]byte(v), &strct.Relationtype); err != nil {
                return err
             }
        default:
