...
func (strct *MolecularSequenceRepository) MarshalJSON() ([]byte, error) {
	...
	comma = true
    // Marshal the "readsetId" field
    if comma { 
        buf.WriteString(",") 
    }
    buf.WriteString("\"readsetId\": ")
	if tmp, err := json.Marshal(strct.ReadsetId); err != nil {
		return nil, err
 	} else {
 		buf.Write(tmp)
	}
	...
	comma = true
    // Marshal the "variantsetId" field
    if comma { 
        buf.WriteString(",") 
    }
    buf.WriteString("\"variantsetId\": ")
	if tmp, err := json.Marshal(strct.VariantsetId); err != nil {
		return nil, err
 	} else {
 		buf.Write(tmp)
	}
...
func (strct *MolecularSequenceRepository) UnmarshalJSON(b []byte) error {
    ...
    for k, v := range jsonMap {
        ...
        case "readsetId":
            if err := json.Unmarshal([]byte(v), &strct.ReadsetId); err != nil {
                return err
             }
        case "type":
        ...
        case "variantsetId":
            if err := json.Unmarshal([]byte(v), &strct.VariantsetId); err != nil {
                return err
             }
        default:
