...
func (strct *MedicationRequestSubstitution) MarshalJSON() ([]byte, error) {
	...
	buf.WriteString("{")
    comma := false
    // Marshal the "allowedBoolean" field
    if comma { 
        buf.WriteString(",") 
    }
    buf.WriteString("\"allowedBoolean\": ")
	if tmp, err := json.Marshal(strct.AllowedBoolean); err != nil {
		return nil, err
 	} else {
 		buf.Write(tmp)
	}
	comma = true
    // Marshal the "allowedCodeableConcept" field
    if comma { 
        buf.WriteString(",") 
    }
    buf.WriteString("\"allowedCodeableConcept\": ")
	if tmp, err := json.Marshal(strct.AllowedCodeableConcept); err != nil {
		return nil, err
 	} else {
 		buf.Write(tmp)
	}
...
func (strct *MedicationRequestSubstitution) UnmarshalJSON(b []byte) error {
    ...
    for k, v := range jsonMap {
        switch k {
        case "allowedBoolean":
            if err := json.Unmarshal([]byte(v), &strct.AllowedBoolean); err != nil {
                return err
             }
        case "allowedCodeableConcept":
            if err := json.Unmarshal([]byte(v), &strct.AllowedCodeableConcept); err != nil {
                return err
             }
        case "extension":
