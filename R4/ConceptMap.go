...
func (strct *ConceptMap) MarshalJSON() ([]byte, error) {
	...
	comma = true
    // Marshal the "sourceCanonical" field
    if comma { 
        buf.WriteString(",") 
    }
    buf.WriteString("\"sourceCanonical\": ")
	if tmp, err := json.Marshal(strct.SourceCanonical); err != nil {
		return nil, err
 	} else {
 		buf.Write(tmp)
	}
	...
	comma = true
    // Marshal the "targetCanonical" field
    if comma { 
        buf.WriteString(",") 
    }
    buf.WriteString("\"targetCanonical\": ")
	if tmp, err := json.Marshal(strct.TargetCanonical); err != nil {
		return nil, err
 	} else {
 		buf.Write(tmp)
	}
	comma = true
    // Marshal the "targetUri" field
    if comma { 
        buf.WriteString(",") 
    }
    buf.WriteString("\"targetUri\": ")
	if tmp, err := json.Marshal(strct.TargetUri); err != nil {
		return nil, err
 	} else {
 		buf.Write(tmp)
	}
...
func (strct *ConceptMap) UnmarshalJSON(b []byte) error {
    ...
    for k, v := range jsonMap {
        ...
        case "sourceCanonical":
            if err := json.Unmarshal([]byte(v), &strct.SourceCanonical); err != nil {
                return err
             }
        case "sourceUri":
        ...
        case "targetCanonical":
            if err := json.Unmarshal([]byte(v), &strct.TargetCanonical); err != nil {
                return err
             }
        case "targetUri":
            if err := json.Unmarshal([]byte(v), &strct.TargetUri); err != nil {
                return err
             }
        case "text":
