...
type StructureDefinition struct {
  ...
  Derivation interface{} `json:"derivation,omitempty"`
...
func (strct *StructureDefinition) MarshalJSON() ([]byte, error) {
	...
	comma = true
    // Marshal the "baseDefinition" field
    if comma { 
        buf.WriteString(",") 
    }
    buf.WriteString("\"baseDefinition\": ")
	if tmp, err := json.Marshal(strct.BaseDefinition); err != nil {
		return nil, err
 	} else {
 		buf.Write(tmp)
	}
	...
	comma = true
    // Marshal the "contextInvariant" field
    if comma { 
        buf.WriteString(",") 
    }
    buf.WriteString("\"contextInvariant\": ")
	if tmp, err := json.Marshal(strct.ContextInvariant); err != nil {
		return nil, err
 	} else {
 		buf.Write(tmp)
	}
	...
	comma = true
    // Marshal the "derivation" field
    if comma { 
        buf.WriteString(",") 
    }
    buf.WriteString("\"derivation\": ")
	if tmp, err := json.Marshal(strct.Derivation); err != nil {
		return nil, err
 	} else {
 		buf.Write(tmp)
	}
	...
	comma = true
    // Marshal the "differential" field
    if comma { 
        buf.WriteString(",") 
    }
    buf.WriteString("\"differential\": ")
	if tmp, err := json.Marshal(strct.Differential); err != nil {
		return nil, err
 	} else {
 		buf.Write(tmp)
	}
	...
	comma = true
    // Marshal the "snapshot" field
    if comma { 
        buf.WriteString(",") 
    }
    buf.WriteString("\"snapshot\": ")
	if tmp, err := json.Marshal(strct.Snapshot); err != nil {
		return nil, err
 	} else {
 		buf.Write(tmp)
	}
...
func (strct *StructureDefinition) UnmarshalJSON(b []byte) error {
    ...
    for k, v := range jsonMap {
        ...
        case "baseDefinition":
            if err := json.Unmarshal([]byte(v), &strct.BaseDefinition); err != nil {
                return err
             }
        case "contact":
        ...
        case "contextInvariant":
            if err := json.Unmarshal([]byte(v), &strct.ContextInvariant); err != nil {
                return err
             }
        case "copyright":
        ...
        case "derivation":
            if err := json.Unmarshal([]byte(v), &strct.Derivation); err != nil {
                return err
             }
        case "description":
        ...
        case "differential":
            if err := json.Unmarshal([]byte(v), &strct.Differential); err != nil {
                return err
             }
        case "experimental":
        ...
        case "snapshot":
            if err := json.Unmarshal([]byte(v), &strct.Snapshot); err != nil {
                return err
             }
        case "status":
