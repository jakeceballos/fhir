...
func (strct *ImplementationGuideManifest) MarshalJSON() ([]byte, error) {
	...
	comma = true
    // Marshal the "rendering" field
    if comma { 
        buf.WriteString(",") 
    }
    buf.WriteString("\"rendering\": ")
	if tmp, err := json.Marshal(strct.Rendering); err != nil {
		return nil, err
 	} else {
 		buf.Write(tmp)
	}
...
func (strct *ImplementationGuideManifest) UnmarshalJSON(b []byte) error {
    ...
    for k, v := range jsonMap {
        ...
        case "rendering":
            if err := json.Unmarshal([]byte(v), &strct.Rendering); err != nil {
                return err
             }
        case "resource":
