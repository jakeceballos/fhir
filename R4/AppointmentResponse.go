...
func (strct *AppointmentResponse) MarshalJSON() ([]byte, error) {
    ...
    if strct.Appointment == nil {
        return nil, errors.New("appointment is a required field")
    }
	...
	comma = true
    // Marshal the "participantStatus" field
    if comma { 
        buf.WriteString(",") 
    }
    buf.WriteString("\"participantStatus\": ")
	if tmp, err := json.Marshal(strct.ParticipantStatus); err != nil {
		return nil, err
 	} else {
 		buf.Write(tmp)
	}
	comma = true
    // Marshal the "participantType" field
    if comma { 
        buf.WriteString(",") 
    }
    buf.WriteString("\"participantType\": ")
	if tmp, err := json.Marshal(strct.ParticipantType); err != nil {
		return nil, err
 	} else {
 		buf.Write(tmp)
	}
...
func (strct *AppointmentResponse) UnmarshalJSON(b []byte) error {
    ...
    for k, v := range jsonMap {
        ...
        case "participantStatus":
            if err := json.Unmarshal([]byte(v), &strct.ParticipantStatus); err != nil {
                return err
             }
        case "participantType":
            if err := json.Unmarshal([]byte(v), &strct.ParticipantType); err != nil {
                return err
             }
        case "resourceType":
    ...
    // check if appointment (a required property) was received
    if !appointmentReceived {
        return errors.New("\"appointment\" is required but was not present")
    }
