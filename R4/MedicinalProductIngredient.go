...
func (strct *MedicinalProductIngredient) MarshalJSON() ([]byte, error) {
	...
	comma = true
    // Marshal the "specifiedSubstance" field
    if comma { 
        buf.WriteString(",") 
    }
    buf.WriteString("\"specifiedSubstance\": ")
	if tmp, err := json.Marshal(strct.SpecifiedSubstance); err != nil {
		return nil, err
 	} else {
 		buf.Write(tmp)
	}
...
func (strct *MedicinalProductIngredient) UnmarshalJSON(b []byte) error {
    ...
    for k, v := range jsonMap {
        ...
        case "specifiedSubstance":
            if err := json.Unmarshal([]byte(v), &strct.SpecifiedSubstance); err != nil {
                return err
             }
        case "substance":
