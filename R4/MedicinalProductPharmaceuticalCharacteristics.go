...
func (strct *MedicinalProductPharmaceuticalCharacteristics) MarshalJSON() ([]byte, error) {
...
func (strct *MedicinalProductPharmaceuticalCharacteristics) UnmarshalJSON(b []byte) error {
    codeReceived := false
