...
func (strct *ConsentVerification) MarshalJSON() ([]byte, error) {
	...
	comma = true
    // Marshal the "verificationDate" field
    if comma { 
        buf.WriteString(",") 
    }
    buf.WriteString("\"verificationDate\": ")
	if tmp, err := json.Marshal(strct.VerificationDate); err != nil {
		return nil, err
 	} else {
 		buf.Write(tmp)
	}
	...
	comma = true
    // Marshal the "verifiedWith" field
    if comma { 
        buf.WriteString(",") 
    }
    buf.WriteString("\"verifiedWith\": ")
	if tmp, err := json.Marshal(strct.VerifiedWith); err != nil {
		return nil, err
 	} else {
 		buf.Write(tmp)
	}
...
func (strct *ConsentVerification) UnmarshalJSON(b []byte) error {
    ...
    for k, v := range jsonMap {
        ...
        case "verificationDate":
            if err := json.Unmarshal([]byte(v), &strct.VerificationDate); err != nil {
                return err
             }
        case "verified":
        ...
        case "verifiedWith":
            if err := json.Unmarshal([]byte(v), &strct.VerifiedWith); err != nil {
                return err
             }
        default:
