...
func (strct *SubstancePolymerDegreeOfPolymerisation) MarshalJSON() ([]byte, error) {
	...
	comma = true
    // Marshal the "degree" field
    if comma { 
        buf.WriteString(",") 
    }
    buf.WriteString("\"degree\": ")
	if tmp, err := json.Marshal(strct.Degree); err != nil {
		return nil, err
 	} else {
 		buf.Write(tmp)
	}
...
func (strct *SubstancePolymerDegreeOfPolymerisation) UnmarshalJSON(b []byte) error {
    ...
    for k, v := range jsonMap {
        ...
        case "degree":
            if err := json.Unmarshal([]byte(v), &strct.Degree); err != nil {
                return err
             }
        case "extension":
