...
func (strct *MedicinalProductName) MarshalJSON() ([]byte, error) {
	buf := bytes.NewBuffer(make([]byte, 0))
	buf.WriteString("{")
    comma := false
    // Marshal the "countryLanguage" field
    if comma { 
        buf.WriteString(",") 
    }
    buf.WriteString("\"countryLanguage\": ")
	if tmp, err := json.Marshal(strct.CountryLanguage); err != nil {
		return nil, err
 	} else {
 		buf.Write(tmp)
	}
	...
	comma = true
    // Marshal the "namePart" field
    if comma { 
        buf.WriteString(",") 
    }
    buf.WriteString("\"namePart\": ")
	if tmp, err := json.Marshal(strct.NamePart); err != nil {
		return nil, err
 	} else {
 		buf.Write(tmp)
	}
...
func (strct *MedicinalProductName) UnmarshalJSON(b []byte) error {
    ...
    for k, v := range jsonMap {
        ...
        case "countryLanguage":
            if err := json.Unmarshal([]byte(v), &strct.CountryLanguage); err != nil {
                return err
             }
        case "extension":
        ...
        case "namePart":
            if err := json.Unmarshal([]byte(v), &strct.NamePart); err != nil {
                return err
             }
        case "productName":
