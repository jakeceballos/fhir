...
type CodeSystem struct {
  ...
  HierarchyMeaning interface{} `json:"hierarchyMeaning,omitempty"`
...
func (strct *CodeSystem) MarshalJSON() ([]byte, error) {
	...
	buf.WriteString("{")
    comma := false
    // Marshal the "caseSensitive" field
    if comma { 
        buf.WriteString(",") 
    }
    buf.WriteString("\"caseSensitive\": ")
	if tmp, err := json.Marshal(strct.CaseSensitive); err != nil {
		return nil, err
 	} else {
 		buf.Write(tmp)
	}
	...
	comma = true
    // Marshal the "hierarchyMeaning" field
    if comma { 
        buf.WriteString(",") 
    }
    buf.WriteString("\"hierarchyMeaning\": ")
	if tmp, err := json.Marshal(strct.HierarchyMeaning); err != nil {
		return nil, err
 	} else {
 		buf.Write(tmp)
	}
	...
	comma = true
    // Marshal the "supplements" field
    if comma { 
        buf.WriteString(",") 
    }
    buf.WriteString("\"supplements\": ")
	if tmp, err := json.Marshal(strct.Supplements); err != nil {
		return nil, err
 	} else {
 		buf.Write(tmp)
	}
	...
	comma = true
    // Marshal the "versionNeeded" field
    if comma { 
        buf.WriteString(",") 
    }
    buf.WriteString("\"versionNeeded\": ")
	if tmp, err := json.Marshal(strct.VersionNeeded); err != nil {
		return nil, err
 	} else {
 		buf.Write(tmp)
	}
...
func (strct *CodeSystem) UnmarshalJSON(b []byte) error {
    ...
    for k, v := range jsonMap {
        switch k {
        case "caseSensitive":
            if err := json.Unmarshal([]byte(v), &strct.CaseSensitive); err != nil {
                return err
             }
        case "compositional":
        ...
        case "hierarchyMeaning":
            if err := json.Unmarshal([]byte(v), &strct.HierarchyMeaning); err != nil {
                return err
             }
        case "id":
        ...
        case "supplements":
            if err := json.Unmarshal([]byte(v), &strct.Supplements); err != nil {
                return err
             }
        case "text":
        ...
        case "versionNeeded":
            if err := json.Unmarshal([]byte(v), &strct.VersionNeeded); err != nil {
                return err
             }
        default:
