...
func (strct *SubstanceReferenceInformationGeneElement) MarshalJSON() ([]byte, error) {
...
func (strct *SubstanceReferenceInformationGeneElement) UnmarshalJSON(b []byte) error {
