...
func (strct *MedicinalProductUndesirableEffect) MarshalJSON() ([]byte, error) {
	...
	comma = true
    // Marshal the "frequencyOfOccurrence" field
    if comma { 
        buf.WriteString(",") 
    }
    buf.WriteString("\"frequencyOfOccurrence\": ")
	if tmp, err := json.Marshal(strct.FrequencyOfOccurrence); err != nil {
		return nil, err
 	} else {
 		buf.Write(tmp)
	}
	...
	comma = true
    // Marshal the "symptomConditionEffect" field
    if comma { 
        buf.WriteString(",") 
    }
    buf.WriteString("\"symptomConditionEffect\": ")
	if tmp, err := json.Marshal(strct.SymptomConditionEffect); err != nil {
		return nil, err
 	} else {
 		buf.Write(tmp)
	}
...
func (strct *MedicinalProductUndesirableEffect) UnmarshalJSON(b []byte) error {
    ...
    for k, v := range jsonMap {
        ...
        case "frequencyOfOccurrence":
            if err := json.Unmarshal([]byte(v), &strct.FrequencyOfOccurrence); err != nil {
                return err
             }
        case "id":
        ...
        case "symptomConditionEffect":
            if err := json.Unmarshal([]byte(v), &strct.SymptomConditionEffect); err != nil {
                return err
             }
        case "text":
