...
func (strct *InsurancePlanCost) MarshalJSON() ([]byte, error) {
	...
	comma = true
    // Marshal the "qualifiers" field
    if comma { 
        buf.WriteString(",") 
    }
    buf.WriteString("\"qualifiers\": ")
	if tmp, err := json.Marshal(strct.Qualifiers); err != nil {
		return nil, err
 	} else {
 		buf.Write(tmp)
	}
...
func (strct *InsurancePlanCost) UnmarshalJSON(b []byte) error {
    ...
    for k, v := range jsonMap {
        ...
        case "qualifiers":
            if err := json.Unmarshal([]byte(v), &strct.Qualifiers); err != nil {
                return err
             }
        case "type":
