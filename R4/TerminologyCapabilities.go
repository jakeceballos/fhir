...
type TerminologyCapabilities struct {
  ...
  CodeSearch interface{} `json:"codeSearch,omitempty"`
...
func (strct *TerminologyCapabilities) MarshalJSON() ([]byte, error) {
	...
	buf.WriteString("{")
    comma := false
    // Marshal the "closure" field
    if comma { 
        buf.WriteString(",") 
    }
    buf.WriteString("\"closure\": ")
	if tmp, err := json.Marshal(strct.Closure); err != nil {
		return nil, err
 	} else {
 		buf.Write(tmp)
	}
	comma = true
    // Marshal the "codeSearch" field
    if comma { 
        buf.WriteString(",") 
    }
    buf.WriteString("\"codeSearch\": ")
	if tmp, err := json.Marshal(strct.CodeSearch); err != nil {
		return nil, err
 	} else {
 		buf.Write(tmp)
	}
	comma = true
    // Marshal the "codeSystem" field
    if comma { 
        buf.WriteString(",") 
    }
    buf.WriteString("\"codeSystem\": ")
	if tmp, err := json.Marshal(strct.CodeSystem); err != nil {
		return nil, err
 	} else {
 		buf.Write(tmp)
	}
	...
	comma = true
    // Marshal the "lockedDate" field
    if comma { 
        buf.WriteString(",") 
    }
    buf.WriteString("\"lockedDate\": ")
	if tmp, err := json.Marshal(strct.LockedDate); err != nil {
		return nil, err
 	} else {
 		buf.Write(tmp)
	}
	...
	comma = true
    // Marshal the "validateCode" field
    if comma { 
        buf.WriteString(",") 
    }
    buf.WriteString("\"validateCode\": ")
	if tmp, err := json.Marshal(strct.ValidateCode); err != nil {
		return nil, err
 	} else {
 		buf.Write(tmp)
	}
...
func (strct *TerminologyCapabilities) UnmarshalJSON(b []byte) error {
    ...
    for k, v := range jsonMap {
        switch k {
        case "closure":
            if err := json.Unmarshal([]byte(v), &strct.Closure); err != nil {
                return err
             }
        case "codeSearch":
            if err := json.Unmarshal([]byte(v), &strct.CodeSearch); err != nil {
                return err
             }
        case "codeSystem":
            if err := json.Unmarshal([]byte(v), &strct.CodeSystem); err != nil {
                return err
             }
        case "contact":
        ...
        case "lockedDate":
            if err := json.Unmarshal([]byte(v), &strct.LockedDate); err != nil {
                return err
             }
        case "meta":
        ...
        case "validateCode":
            if err := json.Unmarshal([]byte(v), &strct.ValidateCode); err != nil {
                return err
             }
        case "version":
