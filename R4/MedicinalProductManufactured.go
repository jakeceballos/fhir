...
func (strct *MedicinalProductManufactured) MarshalJSON() ([]byte, error) {
	...
	comma = true
    // "ManufacturedDoseForm" field is required
    if strct.ManufacturedDoseForm == nil {
        return nil, errors.New("manufacturedDoseForm is a required field")
    }
    // Marshal the "manufacturedDoseForm" field
    if comma { 
        buf.WriteString(",") 
    }
    buf.WriteString("\"manufacturedDoseForm\": ")
	if tmp, err := json.Marshal(strct.ManufacturedDoseForm); err != nil {
		return nil, err
 	} else {
 		buf.Write(tmp)
	}
...
func (strct *MedicinalProductManufactured) UnmarshalJSON(b []byte) error {
    manufacturedDoseFormReceived := false
    ...
    for k, v := range jsonMap {
        ...
        case "manufacturedDoseForm":
            if err := json.Unmarshal([]byte(v), &strct.ManufacturedDoseForm); err != nil {
                return err
             }
            manufacturedDoseFormReceived = true
        case "manufacturer":
    ...
    // check if manufacturedDoseForm (a required property) was received
    if !manufacturedDoseFormReceived {
        return errors.New("\"manufacturedDoseForm\" is required but was not present")
    }
