...
func (strct *Slot) MarshalJSON() ([]byte, error) {
	...
	comma = true
    // Marshal the "overbooked" field
    if comma { 
        buf.WriteString(",") 
    }
    buf.WriteString("\"overbooked\": ")
	if tmp, err := json.Marshal(strct.Overbooked); err != nil {
		return nil, err
 	} else {
 		buf.Write(tmp)
	}
...
func (strct *Slot) UnmarshalJSON(b []byte) error {
    ...
    for k, v := range jsonMap {
        ...
        case "overbooked":
            if err := json.Unmarshal([]byte(v), &strct.Overbooked); err != nil {
                return err
             }
        case "resourceType":
