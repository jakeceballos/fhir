...
func (strct *MedicinalProductIngredientSpecifiedSubstance) MarshalJSON() ([]byte, error) {
    ...
    if strct.Group == nil {
        return nil, errors.New("group is a required field")
    }
...
func (strct *MedicinalProductIngredientSpecifiedSubstance) UnmarshalJSON(b []byte) error {
    codeReceived := false
    groupReceived := false
