...
func (strct *MedicinalProductContraindication) MarshalJSON() ([]byte, error) {
	...
	comma = true
    // Marshal the "disease" field
    if comma { 
        buf.WriteString(",") 
    }
    buf.WriteString("\"disease\": ")
	if tmp, err := json.Marshal(strct.Disease); err != nil {
		return nil, err
 	} else {
 		buf.Write(tmp)
	}
	...
	comma = true
    // Marshal the "therapeuticIndication" field
    if comma { 
        buf.WriteString(",") 
    }
    buf.WriteString("\"therapeuticIndication\": ")
	if tmp, err := json.Marshal(strct.TherapeuticIndication); err != nil {
		return nil, err
 	} else {
 		buf.Write(tmp)
	}
...
func (strct *MedicinalProductContraindication) UnmarshalJSON(b []byte) error {
    ...
    for k, v := range jsonMap {
        ...
        case "disease":
            if err := json.Unmarshal([]byte(v), &strct.Disease); err != nil {
                return err
             }
        case "diseaseStatus":
        ...
        case "therapeuticIndication":
            if err := json.Unmarshal([]byte(v), &strct.TherapeuticIndication); err != nil {
                return err
             }
        default:
