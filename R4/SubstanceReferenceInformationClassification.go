...
func (strct *SubstanceReferenceInformationClassification) MarshalJSON() ([]byte, error) {
...
func (strct *SubstanceReferenceInformationClassification) UnmarshalJSON(b []byte) error {
